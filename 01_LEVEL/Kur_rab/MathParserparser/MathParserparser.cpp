...
// Member functions
TParserNode *T_Parser::CreateNode(double _value, TParserNode *_left, TParserNode *_right)
{
...
void T_Parser::SendError(int errNum)
{
...
bool T_Parser::Compile(char *_expr)
{
   pos = 0;
   expr = _expr;
   *curToken = '\0';
...
TParserNode *T_Parser::Expr(void)
{
...
TParserNode *T_Parser::Expr1(void)
{
...
TParserNode *T_Parser::Expr2(void)
{
...
TParserNode *T_Parser::Expr3(void)
{
   TParserNode *temp;
...
TParserNode *T_Parser::Expr4(void)
{
   TParserNode *temp;
...
double T_Parser::Evaluate(void)
{
   result = CalcTree(root);
   return result;
}

double T_Parser::CalcTree(TParserNode *tree)
{
   static double temp;
...
void T_Parser::DelTree(TParserNode *tree)
{
   if(tree==NULL) return;
